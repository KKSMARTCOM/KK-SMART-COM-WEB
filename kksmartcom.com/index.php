<!DOCTYPE html>
<html lang="fr" class="" id="html" translate="no">
...
<head>
	...
	<meta property="og:title"
		content="Nous fournissons un service complet pour les startups et les entreprises établies - KK SMART COM" />
	...
	<div class="page-preloader" id="pageloader" data-src="wp-content/themes/kksmartcom/img/black-bg.png">
		<div class="wrap">
			<div class="preloader-wrap">
				<b>Chargement :</b> <span id="loadcntr">001</span><sup><img loading="lazy" width="25" height="25"
			...
			<div class="wrap">
				<div class="flex-row">
					...
					<nav class="main-menu-wrap">
						<ul>
										...
										<div class="col">
											...
											<ul>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Réseaux sociaux</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Web Design</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Site Web</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Application web</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Application Mobile</a></li>
											</ul>
										</div>
										<div class="col">
											...
											<ul>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Identité de marque</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Graphisme</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Impression numérique</a></li>
											</ul>
										</div>
										<div class="col">
											...
											<ul>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Photographie</a></li>
												<li class=""><a class="" href="https://comeup.com/fr/@kk-smart-com"
														target="_blank">Vidéographie</a></li>
											</ul>
										</div>
										<div class="col">
							...
							<li class="menu-item-has-children"><a class="" href="https://www.behance.net/kksmartcom"
									target="_blank">Projets</a>
							</li>
							<li class="menu-item-has-children"><a class="" href="#" target="_blank">Entreprise</a> <svg
								...
								<div class="sub-menu white-background">
									<div class="menu-inner wrap"> <a href="#" class="circle-btn lime"><span><svg
										...
										<div class="col" style="margin-right:auto;">
											...
											<ul>
												<li class=""><a class="" href="apropos.html" target="_self">A
														propos</a></li>
					...
					<div class="header-arr-wrap">
						<div class="langs-wrap main-menu-wrap">
							<ul id="menu-langs-menu" class="menu">
								<li id="menu-item-10096"
									...
									<a href="#">FRA</a><svg width="8" height="3" viewBox="0 0 8 3" fill="none"
										xmlns="http://www.w3.org/2000/svg">
										<path d="M0.5 0H7.5L4 3L0.5 0Z"/>
									</svg>
									<ul class="sub-menu">
								...
								<div class="mob-visible">
									<a href="#" class="logo">
										<svg id="Calque_1" data-name="Calque 1" height="35"
											xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1511.51 402.54">
											<defs>
												<style>
													.cls-1 {
														fill: #4385f3;
									...
									<div class="flex-modal-wrap">
										<div class="left black-background">
											<div class="top view textslide">
												<div class="section-title medium"> Avez-vous besoin d'aide pour
													concrétiser une idée ?
												</div>
												<div class="l-wrap"> <a href="mailto:hello@kksmartcom.com"
														class="line-animation email">hello@kksmartcom.com</a> <b
														class="copyme_wrap">
														<img style="margin-left:0!important"
															src="wp-content/themes/kksmartcom/img/copy.svg"
											...
											<div class="bottom socs-wrap">
												<div class="socs view textslide">
													<a target="_blank" rel="noopener noreferrer nofollow"
														href="https://wa.me/22956141438" class="whatsapp wide"><img
															width="20" height="20" loading="lazy"
															src="wp-content/themes/kksmartcom/img/s8.svg" alt="">
														<span>Whatsapp</span>
													</a>
												</div>
											</div>
										...
										<div class="right black-background">
											<form action="https://kksmartcom.com/thanks" method="post"
												autocomplete="off" enctype="multipart/form-data"
												class="main_contact_form2"> <input type="hidden" name="currency"
													value="USD"> <input type="hidden" name="price" id="price_1"> <label
													for="inpname_1" class="inp-wrap view textslide"> <input type="text"
														id="inpname_1" placeholder=" " name="your_name" required=""
														autocomplete="on" data-max-length="40"
														class="required max-length pattern" data-pattern="[A-Za-z]">
													<span>Votre nom et prénoms<sup>*</sup></span> </label> <label
													for="inpemail_1" class="inp-wrap view textslide"> <input
														type="email" id="inpemail_1" placeholder=" " name="your_email"
														autocomplete="on" required="" class="required pattern"
														data-pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
														data-message-error="Your Email is invalid"> <span>Votre
														email<sup>*</sup></span>
												</label> <label for="inptext_1" class="inp-wrap view textslide">
													<textarea placeholder=" " id="inptext_1" name="your_text"
														data-message-error="Max length 1000 characters"
														class="max-length" data-max-length="1000"></textarea>
													<span>Parlez nous de votre projet</span> <span class="counter"
														data-max="250"> <b>0</b>/1000 </span> </label>
												<div class="attach-wrap view textslide">
													<div id="inner_1"> </div> <label for="attach_1"> <input type="file"
															id="attach_1" multiple="" name="files_arr[]"> <img
															src="https://kksmartcom.com/wp-content/themes/kksmartcom/img/sk.svg"
															alt="">Pièce jointe</label>
												</div>
												<div class="file-err err fe1_1">Vous pouvez télécharger un maximum de 5
													fichiers</div>
												<div class="file-err err fe2_1">Une partie de votre fichier n'est pas
													chargée, car la taille
											...
											data-message-error=""> <span>J'accepte <a
												href="https://kksmartcom.com/cookies-policy" target="_blank">politique
												de confidentialité</a></span> </label> </div> --> <button class="main-btn arrow white"><span><svg
						...
						<a href="#contact-form" class="arrow-btn"><span></span>Cliquez ici</a>
					</div>
					<div class="gam"></div>
				</div>
			</div>
			...
			<ul id="menu-mobile-menu" class="menu">
					...
					<ul class="sub-menu">
						<li id="menu-item-10396"
							class="menu-item menu-item-type-post_type menu-item-object-page menu-item-10396"><a
								href="https://comeup.com/fr/@kk-smart-com"><span class="a-line"><span>Réseaux
						...
						<li id="menu-item-10295"
							class="menu-item menu-item-type-post_type menu-item-object-service menu-item-10295"><a
								href="https://comeup.com/fr/@kk-smart-com"><span class="a-line"><span>Site
										Web</span></span></a></li>
						<li id="menu-item-10298"
							class="menu-item menu-item-type-post_type menu-item-object-service menu-item-10298"><a
								href="https://comeup.com/fr/@kk-smart-com"><span class="a-line"><span>Application
										web</span></span></a></li>
				...
				<li id="menu-item-7141"
					...
					<ul class="sub-menu">
						<li id="menu-item-10396"
							class="menu-item menu-item-type-post_type menu-item-object-page menu-item-10396"><a
								href="apropos.html"><span class="a-line"><span>A propos</span></span></a></li>
						<li id="menu-item-10294"
							class="menu-item menu-item-type-post_type menu-item-object-service menu-item-10294"><a
				...
				<li id="menu-item-10097"
					...
					<a href="#pll_switcher"><span class="a-line"><span>FRA</span></span></a>
					<ul class="sub-menu" style="display: none; box-sizing: border-box;">
						<li id="menu-item-10097-fr"
							class="lang-item lang-item-97 lang-item-en current-lang lang-item-first menu-item menu-item-type-custom menu-item-object-custom current_page_item menu-item-home menu-item-10097-fr">
							<a href="#" hreflang="fr" lang="fr"><span
						...
						<li id="menu-item-10097-it"
							...
							<a href="indexen.html" hreflang="en-EN" lang="en-EN"><span class="a-line"><span>ENG</span></span></a>
						</li>
					</ul><span class="sub-menu-opener"></span>
				</li>
			</ul>
	...
	<div class="screen2 white-background section is_view">
		<div class="wrap view hidden-block hidd_block">
			<div class="flex-row">
				...
				<div class="w60">
					<h2 class="section-heading view meow"> Service de communication <br> complet pour <br>les
						startups
			...
			<div class="flex-cases">
				...
				// Récupérer jusqu'à 4 projets avec image1
				$sql = "SELECT * FROM projects WHERE imageOrVideo IS NOT NULL LIMIT 4";
				$result = $conn->query($sql);

				// Afficher les projets
				while ($row = $result->fetch_assoc()) {
					$projectId = $row['id'];
					$overview = getOverview($conn, $projectId);

					// Utiliser le lien de la base de données s'il existe, sinon utiliser le lien par défaut
					$projectLink = !empty($row["link"]) ? $row["link"] : "/websmart/kksmartcom.com/project-details.php?id=" . $projectId;

					// Ajouter target="_blank" si le lien est spécifié
					$linkAttributes = !empty($row["link"]) ? 'target="_blank"' : '';

					?>
					<div class="case view textslide delay0">
						<?php
						// Vérifier si une image est présente
						if (!empty($row["imageOrVideo"])) {
							$imageUrl = "/kksmartcom/kkadmin/public/images/projects/" . $row["imageOrVideo"];
							
							echo '<a href="' . $projectLink . '" ' . $linkAttributes . ' class="img-wrap view">';
							echo '<img class="" loading="lazy" src="' . $imageUrl . '" alt="' . $row["title"] . '">';
							echo '</a>';
						} else {
						...
						?>
						<div class="name-wrap">
							<a href="<?= $projectLink ?>" class="name"><?= $overview['title'] ?></a>
							<a href="<?= $projectLink ?>" class="main-btn arrow">
								<span>
									<svg fill="none" height="10" viewBox="0 0 9 10" width="9" xmlns="http://www.w3.org/2000/svg">
										<path clip-rule="evenodd" d="m.455752.5h8.544248v8.54425h-1.28906v-6.34368l-6.799434 6.79943-.911506-.91151 6.79943-6.79943h-6.343678z" fill="#fffefd" fill-rule="evenodd" />
									</svg>Voir
								</span>
							</a>
						</div>
						<div class="tags-wrap">
							...
							$servicesArray = json_decode($overview['service'], true);

							// Vérifier si la conversion JSON a réussi
							if ($servicesArray !== null) {
								// Parcourir le tableau et afficher chaque valeur comme un tag
								foreach ($servicesArray as $service) {
									echo '<a href="' . $projectLink . '" ' . $linkAttributes . ' class="tag">' . $service['value'] . '</a>';
								}
							} else {
								echo '<span class="tag">Erreur de format</span>';
							}
							?>
						</div> <br>
						<?php
						$description = html_entity_decode(strip_tags($overview["description"]));
						echo '<h3>' . htmlspecialchars(strlen($description) > 200 ? substr($description, 0, 200) . '...' : $description, ENT_QUOTES, 'UTF-8') . '</h3>';
						?>
					</div>
				<?php
				}
				...
				function getOverview($conn, $projectId)
				{
					$sql = "SELECT * FROM overview WHERE id_project = ?";
			...
			<div class="text-center view textslide"> <a href="https://www.behance.net/kksmartcom"
					class="circle-btn black"><span><svg width="11" height="11" viewBox="0 0 11 11" fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd"
								d="M5.5 0L11 5.5L5.5 11L4.67022 10.1702L8.7537 6H0V5H8.7537L4.67022 0.829781L5.5 0Z"
								fill="#1F2122" />
			...
			<div class="flex-row bottom-row">
				<div class="w30">
					<!-- <video muted="" loop="" playsinline="" autoplay="" preload="none"
						...
						<source src="wp-content/uploads/2021/10/chain.svg" type='video/mp4; codecs="hvc1"'>
						<source src="wp-content/uploads/2021/10/chain.svg" type="video/webm">
						<source src="wp-content/uploads/2021/10/chain.svg" type="video/webm">
					</video> -->

					<picture>
						<source media="(min-width: 1600px)"
							srcset="../cdn.kksmartcom.com/wp-content/uploads/2021/10/chain.svg">
						<source media="(max-width: 1100px)"
							srcset="../cdn.kksmartcom.com/wp-content/uploads/2021/10/chain.svg">
						<source media="(min-width: 1101px) and (max-width:1599px)"
							srcset="../cdn.kksmartcom.com/wp-content/uploads/2021/10/chain.svg">
						<img width="400" height="400" class="rotate-star view fadein active viewed" loading="lazy"
							src="../cdn.kksmartcom.com/wp-content/uploads/2021/10/chain.svg" alt="Projets">
					</picture>
	...
	<div class="screen3 black-background section is_view">
		<div class="screen3 black-background section is_view">
			...
			<div class="section newabout-screen3 black-background is_view target_section">
					...
					<div class="reviews_wrap view fadein active viewed">
						<div class="reviews_slider swiper swiper-backface-hidden swiper-initialized swiper-horizontal swiper-pointer-events swiper-autoheight" style="padding-left: 20px; padding-right: 20px;">
							<div class="swiper-wrapper" id="swiper-wrapper-912101093246e7d458" aria-live="polite" style="height: 435px; transform: translate3d(0px, 0px, 0px);">
								...
								// Récupérer les données des témoignages
								...
								if ($result->num_rows > 0) {
									while ($row = $result->fetch_assoc()) {
										?>
										<div class="slide swiper-slide swiper-slide-active" role="group" aria-label="1 / 6" style="width: 518px; height: min-content; margin-right: 15px;">
											<div class="review_inner">
												<div class="top_wrap"><img class="" src="../kkadmin/public/images/testimonials/<?php echo $row["image"]; ?>"  alt="" loading="lazy"></div>
												<div class="text"> 
													<?php echo $row["content"]; ?>
												</div>
												<div class="author"> 
													<img class=""  alt="" src="../kkadmin/public/images/testimonials/<?php echo $row["image"]; ?>"  loading="lazy">
													<div class="bio"> 
												...
												<div class="bottom" style="height: auto;"> 
													<a target="_blank" href="https://www.google.com/search?q=kk+smart+com&oq=kk+smart+com&gs_lcrp=EgZjaHJvbWUqBggAEEUYOzIGCAAQRRg7MgYIARBFGDwyBggCEEUYPDIGCAMQRRg80gEIMjkwMmowajmoAgCwAgA&sourceid=chrome&ie=UTF-8#lrd=0x10235798a3364b93:0x2e31cf5b35f72be8,1,,,,"><img src="wp-content/themes/kksmartcom/img/au2.svg" alt="">Lire Plus</a>
												</div>
											</div>
										</div>
										<?php
									...
									<div class="row light full none">
										<div class="top"></div>
										<div class="h"> Aucun témoignage enregistré </div>
										<div class="p big"></div>
									</div>
									<?php
								}
						...
						<div class="flex-row mrgt120">
							<div class="w100 view textslide">
								<!-- <div class="section-heading section-heading borderb decorable">
									<div class="pc-visible">Ils nous ont <br><strong>faits</strong> confiance</strong>
									</div>
									<div class="mob-visible">Ils nous ont <br><strong>fait</strong> confiance</strong>
									</div>
								</div> -->
								<div class="section-heading section-heading borderb decorable">
									<div class="pc-visible">Ils nous ont fait confiance
									</div>
									<div class="mob-visible">Ils nous ont fait confiance
									</div>
								</div>
							</div>
						</div>
					...
					<div class="wrap">
						<div class="awards-details">
							<?php
								...
								<?php
								// Votre boucle PHP pour récupérer les clients
								while ($rowClient = $resultClients->fetch_assoc()) {
								?>
									<div class="item">
										<!-- Contenu du client ici -->
										<div class="slide swiper-slide swiper-slide-active">
											<div class="row w35 big">
												<div class="top">
													<div class="left" style="font-size: 30px !important; font-weight: bold;">
														<?php 
														if (!empty($rowClient["nom_image"])) {
															echo '<img class="" style="width: 200px; height: 140px" src="../kkadmin/public/images/clients/' . $rowClient["nom_image"] . '" alt="dd" loading="lazy">';
														} else {
															echo $rowClient["name"];
														}
														?>
													</div>
													<?php if (!empty($rowClient["image"])) { ?>
														<div class="right" id="fo1">
															<img class="" src="../kkadmin/public/images/clients/<?php echo $rowClient["image"]; ?>" alt="" loading="lazy">
														</div>
													<?php } ?>
												</div>
												<div class="h"> </div>
												<div class="p small"><?php echo $rowClient["description"]; ?></div>
											</div>
										</div>
									</div>
								<?php
							...
							<?php
								...
								// Récupérer le nombre total d'awards
								$totalAwardsSql = "SELECT SUM(total) as total FROM awards";
								$totalAwardsResult = $conn->query($totalAwardsSql);
								$totalAwards = $totalAwardsResult->fetch_assoc()['total'];

								// Récupérer le dernier contenu enregistré
								$latestContentSql = "SELECT * FROM awards WHERE content IS NOT NULL ORDER BY id DESC LIMIT 1";
								$latestContentResult = $conn->query($latestContentSql);

								// Vérifier si la requête a réussi
								if ($latestContentResult !== FALSE && $latestContentResult->num_rows > 0) {
									$latestContentRow = $latestContentResult->fetch_assoc();
									$latestContent = $latestContentRow['content'];

									// Afficher le dernier contenu
								?>
									<div class="row light full none">
										<div class="top" id="top">
										<div class="left" >
								<?php
								// Récupérer toutes les images de la table awards
								$allAwardsImagesSql = "SELECT image FROM awards WHERE image IS NOT NULL";
								$allAwardsImagesResult = $conn->query($allAwardsImagesSql);

								// Vérifier si la requête a réussi
								if ($allAwardsImagesResult !== FALSE && $allAwardsImagesResult->num_rows > 0) {
									// Boucle sur les résultats pour afficher toutes les images
									while ($rowImage = $allAwardsImagesResult->fetch_assoc()) {
								?>
										<img class="" style="width: 100px; height: 50px" src="../kkadmin/public/images/awards/<?php echo $rowImage["image"]; ?>" alt="" loading="lazy">
								<?php
									}
								}
								?>
							...
							<div class="right kubok"> <img class="" src="wp-content/uploads/2022/12/5.svg"
														alt="" loading="lazy"> </div>
						</div>
						<div class="h"><?php echo $totalAwards; ?> Awards</div>
						<div class="p big"><?php echo htmlspecialchars($latestContent); ?></div>
					</div>
				<?php
				} else {
				...
				?>
					<div class="row light full none">
						<div class="h mb-3"><?php echo $totalAwards; ?> Awards</div>
						<div class="p big">Aucun contenu enregistré.</div>
					</div>
				<?php
				}
					...
					<div class="top-block">
						...
						<div class="socs-wrap view textslide cwfl">
							<a href="mailto:hello@kksmartcom.com"
								class="line-animation email">hello@kksmartcom.com<!--<img src="https://kksmartcom.com/wp-content/themes/kksmartcom/img/45degarrow.svg" alt="">--></a>
							<img src="wp-content/themes/kksmartcom/img/copy.svg" data-text="hello@kksmartcom.com"
					...
					<div class="left">
						...
						<div class="locations">
							...
							<div class="col">
								...
								<div class="address">
									<img src="wp-content/themes/kksmartcom/img/pin.svg" alt="">
						...
						<div class="socs-wrap">
							<div class="socs">
								...
								<a target="_blank" rel="noopener noreferrer nofollow"
									...
									<img id="imgcomeup" width="20" height="20" loading="lazy" style="color: black;"
		...
		<div class="modal-wrap">
			...
			<div class="modal wrap">
				<div class="flex-modal-wrap black-background">
					<div class="left">
						<div class="top view textslide">
							<div class="sub-title">Merci de nous contacter! <br>Nous vous contacterons bientôt.</div>
							<div class="section-titre">
								Prêt à <b>rejoindre</b> <br>
								la <span>fête ?</span>
							</div>
							<div class="p">Abonnez-vous à nos réseaux sociaux et accédez à du contenu exclusif,
								des aperçus des coulisses, et bien plus encore !</div>
						</div>
						<div class="bottom socs-wrap">
							<div class="socs view textslide">
								<a target="_blank" rel="noopener noreferrer nofollow"
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			var mySwiper = new Swiper('.reviews_slider', {
				...
				autoplay: {
					delay: 5000, // Définir le délai entre les diapositives en millisecondes
					disableOnInteraction: false, // Autoriser l'autoplay même lorsqu'un utilisateur interagit avec la diapositive
				},
				slidesPerView: 1, // Un slide visible à la fois
				...
				on: {
					autoplay: function () {
						// Mettre à jour la position des éléments en dessous des slides après chaque transition d'autoplay
						updateElementsPosition();
					},
				},
			});

			// Facteur d'échelle pour ajuster la hauteur ajoutée
			var scaleFactor = 0.5;

			// Fonction pour mettre à jour la position des éléments en dessous des slides
			function updateElementsPosition() {
				// Récupérer le conteneur des slides
				var reviewsWrap = document.querySelector('.reviews_wrap');

				// Vérifier si le conteneur existe
				if (reviewsWrap) {
					// Récupérer la hauteur du slide actif
					var activeSlideHeight = mySwiper.slides[mySwiper.activeIndex].offsetHeight;

					// Calculer la hauteur ajoutée en fonction du facteur d'échelle
					var addedHeight = activeSlideHeight * scaleFactor;

					// Mettre à jour la position des éléments en dessous des slides
					reviewsWrap.style.marginBottom = addedHeight + 'px';
				}
			}
