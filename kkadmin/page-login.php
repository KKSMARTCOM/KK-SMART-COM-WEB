                                    ...
                                    <div class="auth-form">
                                        <div class="text-center">
                                            <a href="" class="brand-logo">
                                                <svg id="Calque_1" data-name="Calque 1" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1511.51 402.54">
                                                    <defs>
                                                        <style>
                                                            .cls-1 {
                                                                fill: #4385f3;
                                        ...
                                        <form action="login-process.php" method="post">
                                            ...
                                            <div class="form-row d-flex justify-content-between mt-4 mb-5 flex-wrap">
                                                <div class="form-group">
                                                    <div class="checkbox form-check checkbox-event custom-checkbox">
