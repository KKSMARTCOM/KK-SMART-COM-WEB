        ...
        <div class="content-body default-height">
            <div class="container-fluid">
                <!-- <div class="form-head d-flex mb-4 mb-md-5 align-items-start">
                    ...
                    <li>
                        <select onchange="window.location.href=this.value" class="btn btn-primary">
                            <option value="" selected disabled>Catégorie d'articles</option>
                            <option value="blog-category.html">Nom de la catégorie 1</option>
