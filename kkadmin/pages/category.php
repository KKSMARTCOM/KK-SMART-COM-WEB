    ...
    ***********************************-->
	...
	<div class="page-titles">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="javascript:void(0)">Catégorie de blog</a></li>
		</ol>
	</div>
							...
							<div class="card-body">
								<form method="post" action="traitement.php">
									<div class="mb-3">
										...
										<input type="text" name="nomCategorie" id="nomCategorie" class="form-control" placeholder="Nom de la catégorie" required>
									</div>
									<div>
